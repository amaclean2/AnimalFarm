...
TEST_CASES = [
    ...
    TestCase(
        ...
        stop_when=lambda world, tick: any(
            a.health == MAX_HEALTH for a in world.all_living_agents()
        ),
        max_ticks=3,
        assert_fn=lambda world, agent, tick: tick is not None,
    ...
    TestCase(
        ...
        food=[(6, 5)],
        stop_when=lambda world, tick: not world.all_living_agents()
        or any(a.health == MAX_HEALTH for a in world.all_living_agents()),
